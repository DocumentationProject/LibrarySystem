    ...
    return (
        <>
            <div style={{display: 'flex', justifyContent: 'space-between'}}>
                ...
                <Button className='mb-lg-4' onClick={() => setShowCreatePromoCodeModal(true)} type='primary'><PlusOutlined/> Create promo code</Button>
            </div>
            <Table
                columns={columns}
                dataSource={data}
                ...
                loading={loading}
            />
            {showCreatePromoCodeModal && <CreatePromoCodeModal setShowModal={setShowCreatePromoCodeModal} getPromoCodes={getPromoCodes}/>}
        </>
    );
};
